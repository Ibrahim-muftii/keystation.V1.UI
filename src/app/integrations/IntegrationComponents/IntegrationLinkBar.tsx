    ...
    return (
        <div className="w-full p-4">
            <div className="flex bg-[#212121] border border-white/15 rounded-lg">
                ...
                <Link href={'/integrations/facebook'} className={`${pathname === '/integrations/facebook' ? 'bg-[#2f2f2f] text-white' : ''} flex-1 border-r border-white/15 py-3 text-center text-white/65 hover:text-white transition-all duration-300`} >Facebook</Link>
