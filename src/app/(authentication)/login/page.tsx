import LoginForm from "@/app/(authentication)/login/LoginComponents/LoginForm";
            ...
            <main className="w-full h-screen flex justify-center items-center">
                <div className="p-1 rounded-lg bg-white/10 container sm:max-w-xs md:max-w-sm mx-auto">
                    <div className="w-full h-full flex flex-col items-center bg-black p-4 rounded-md">
                        <h5 className="text-xl font-semibold py-5 text-white/80">Welcome to Keystation</h5>
                        <LoginForm/>
                    </div>
                </div>
            </main>
